...
public class JFrame_principal extends javax.swing.JFrame {
    ...
    Libro objLibro;
    Arreglo_Libros objArreglo_Libros = new Arreglo_Libros();


    public JFrame_principal() {
        initComponents();
        objArreglo_Libros.Listar(tblLibro);
    }
    ...
    private void btnMuckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMuckActionPerformed
        ...
        objLibro = new Libro(ISBN, titulo, autor, editorial, precio, stock);
        
        objArreglo_Libros.Agregar(objLibro);
        objArreglo_Libros.Listar(tblLibro);
